...
let counter = 0;
// Unique name: Date.now is available in specs. The counter disambiguates calls within the same ms.
...
type Fixtures = {
  api: SmokeApi;
  // Register created incarnations for destroy in teardown (tolerant of 404).
